        ...
        <nav class="navbar navbar-expand-sm sticky-top navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="salarystatus.php?id=<?php echo $id?>">Salary</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Leave</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="applyleave.php?id=<?php echo $id?>">Apply</a>
                            <a class="dropdown-item" href="leavestatus.php?id=<?php echo $id?>">Status</a>
                    </li>
                    <li class="nav-item">
