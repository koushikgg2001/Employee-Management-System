                ...
                <table class="table table-sm table-condensed">
                    <tbody align=center>
                        <tr>
                            ...
                            <th scope="col" class="text-center py-2">Submission Date</th>
                        ...
                        <?php
                            include 'config.php';
                            $result = mysqli_query($conn, "SELECT * from `project` order by subdate desc");
                            while ($employee = mysqli_fetch_assoc($result)) 
                            {
                        ?>
                        <tr> 
                            <td class="py-2"><?php echo $employee['pid']; ?></td>
                            <td class="py-2"><?php echo $employee['eid']; ?></td>
                            ...
                            <td><a href="mark.php?id= <?php echo $employee['eid'];?>&pid=<?php echo $employee['pid'];?>"> <button type="button" class="btn btn-info">Mark</button></a></td>
                        </tr>
                        <?php
                            }
                        ?>
