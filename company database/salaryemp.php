...
<body>
    ...
    <div class ="background">
        ...
        <div class="container">
            <h3 class = "text-center">Salary Table</h3>
                ...
                <table class="table table-sm table-condensed">
                    <tbody align=center>
                        <tr>
                            ...
                            <th scope="col" class="text-center py-2">TotalSalary</th>
                        </tr>
                        <?php
                            include 'config.php';
                            $result = mysqli_query($conn, "SELECT employee.id,employee.firstName,employee.lastName,salary.base,salary.bonus,salary.total from employee,`salary` where employee.id=salary.id");
